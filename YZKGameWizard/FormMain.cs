...
namespace YZKGameWizard
{
    public partial class FormMain : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (ideVer == "Dev C++")
            {
                CreateDevCppProject(projectDir, projectName, templateDir);
            }
            else
            {                
                CreateVSProject(projectDir, projectName, templateDir, ideVer);
            }
        ...
        private void CreateDevCppProject(string projectDir, string projectName, string templateDir)
        {
            FileInfo projFileNameSrc;//项目文件模板源文件
            FileInfo projFileNameDest;//项目文件模板目标文件
            projFileNameSrc = new FileInfo(Path.Combine(templateDir, "devcpp", "Project1.dev"));
            projFileNameDest = new FileInfo(Path.Combine(projectDir, projectName, projectName + ".dev"));
            ...
            CopyDir(templateDir + "/dlls", projectDir + "/" + projectName);
        ...
        private void CreateVSProject(string projectDir, string projectName, string templateDir, string ideVer)
        {
